...
public class ResponsePartitionedStarredResultLastPageTest {
    ...
    public void before() throws Exception {
        when(headers.get("Link")).thenReturn(TextToString.read(JSON_FILE_PATH + JSON_FILE_STARRED_PAGE_LAST_LINKHEADER, Charsets.UTF_16));
        when(body.string()).thenReturn(TextToString.read(JSON_FILE_PATH + JSON_FILE_STARRED_PAGE_LAST, Charsets.UTF_16));
